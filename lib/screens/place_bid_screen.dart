...
class MyClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path0.cubicTo(
        size.width * 0.1736000,
        size.height * 0.0478000,
        size.width * 0.2904000,
        size.height * 0.0430500,
        size.width * 0.3711000,
        size.height * 0.0478000);
    path0.cubicTo(
        size.width * 0.4030000,
        size.height * 0.0505500,
        size.width * 0.4060000,
        size.height * 0.0766500,
        size.width * 0.4239500,
        size.height * 0.0752000);
    path0.cubicTo(
        size.width * 0.4514500,
        size.height * 0.0851000,
        size.width * 0.5657500,
        size.height * 0.0838000,
        size.width * 0.5776000,
        size.height * 0.0754500);
    path0.cubicTo(
        size.width * 0.6067500,
        size.height * 0.0760500,
        size.width * 0.6075500,
        size.height * 0.0469000,
        size.width * 0.6329500,
        size.height * 0.0473500);
    path0.cubicTo(
        size.width * 0.7006500,
        size.height * 0.0464500,
        size.width * 0.8185500,
        size.height * 0.0484000,
        size.width * 0.8937500,
        size.height * 0.0475000);
    path0.quadraticBezierTo(size.width * 0.9954000, size.height * 0.0384500,
        size.width, size.height * 0.0978000);
